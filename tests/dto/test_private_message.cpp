...
BOOST_AUTO_TEST_CASE(ToJsonSerialization)
{
    ...
    BOOST_TEST(json.contains("receiverUserId"));
    BOOST_TEST(json["receiverUserId"].get<int64_t>() == 42);
    ...
    BOOST_TEST(json.contains("isViewed"));
    BOOST_TEST(json["isViewed"].get<bool>() == true);
}
