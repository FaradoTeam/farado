...
class MockFieldTypeRepository : public repositories::IFieldTypeRepository
{
public:
    void setFindAllResult(std::pair<std::vector<dto::FieldType>, int64_t> result)
    {
    ...
    void setFindAllCallback(
        std::function<std::pair<std::vector<dto::FieldType>, int64_t>(
    ...
    void setFindByIdResult(std::optional<dto::FieldType> fieldType)
    {
        m_findByIdResult = std::move(fieldType);
    }
    ...
    void setFindByItemTypeResult(std::vector<dto::FieldType> fieldTypes)
    {
        m_findByItemTypeResult = std::move(fieldTypes);
    }
    ...
    ) override
    {
        ...
        m_lastFindAllItemTypeId = itemTypeId;
        m_lastFindAllValueType = valueType;
        m_lastFindAllCaptionSearch = captionSearch;
        m_findAllCallCount++;

        if (m_findAllCallback)
        {
            return m_findAllCallback(page, pageSize, itemTypeId, valueType, captionSearch);
        }
        return m_findAllResult;
    }
    ...
    {
        m_lastFindByItemTypeId = itemTypeId;
        m_findByItemTypeCallCount++;
        return m_findByItemTypeResult;
    }
    ...
    int getFindByItemTypeCallCount() const { return m_findByItemTypeCallCount; }
    ...
    const dto::FieldType& getLastCreated() const { return m_lastCreated; }
    const dto::FieldType& getLastUpdated() const { return m_lastUpdated; }
    int64_t getLastRemovedId() const { return m_lastRemovedId; }
    int64_t getLastFindByItemTypeId() const { return m_lastFindByItemTypeId; }
    ...
    void reset()
    {
        ...
        m_removeCallCount = 0;
        m_existsCallCount = 0;
        m_findByItemTypeCallCount = 0;
        m_usageCountCallCount = 0;
        m_findAllCallback = nullptr;
    }

private:
    std::pair<std::vector<dto::FieldType>, int64_t> m_findAllResult;
    std::optional<dto::FieldType> m_findByIdResult;
    int64_t m_createResult = 0;
    bool m_updateResult = false;
    bool m_removeResult = false;
    bool m_existsResult = false;
    std::vector<dto::FieldType> m_findByItemTypeResult;
    ...
    int m_findByItemTypeCallCount = 0;
    int m_usageCountCallCount = 0;

    int m_lastFindAllPage = 0;
    int m_lastFindAllPageSize = 0;
    std::optional<int64_t> m_lastFindAllItemTypeId;
    std::optional<std::string> m_lastFindAllValueType;
    std::string m_lastFindAllCaptionSearch;
    int64_t m_lastFindById = 0;
    dto::FieldType m_lastCreated;
    dto::FieldType m_lastUpdated;
    int64_t m_lastRemovedId = 0;
    int64_t m_lastExistsId = 0;
    int64_t m_lastFindByItemTypeId = 0;
